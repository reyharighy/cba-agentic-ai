...
```text
Berapa rata-rata profit_margin per product?
```
...
Sistem menjelaskan bahwa kolom `profit_margin` tidak ada pada skema `business_data` — tidak menghasilkan angka fiktif.
