...
| ------ | -------- | ---------- |
| `S1-stream.txt` | S1 | Jalur analitik penuh — top 3 product by boxes_shipped |
| `S2-stream.txt` | S2 | Permintaan luar domain |
| `S3-stream.txt` | S3 | Respons langsung (`direct_response`) |
| `S4-stream.txt` | S4 | Data tidak tersedia (`profit_margin`) |
...
| `S8-g1-stream.txt` | S8 giliran 1 | Country tertinggi |
| `S8-g2-stream.txt` | S8 giliran 2 | Country peringkat kedua |
