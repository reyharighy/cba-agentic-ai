...
| ------ | -------- | ---------- |
| `S1-stream.txt` | S1 | Jalur analitik penuh — top 3 merek 2014 |
| `S2-stream.txt` | S2 | Permintaan luar domain |
| `S3-stream.txt` | S3 | Respons langsung (`direct_response`) |
| `S4-stream.txt` | S4 | Data tidak tersedia (`customer_satisfaction`) |
...
| `S8-g1-stream.txt` | S8 giliran 1 | State tertinggi 2014 |
| `S8-g2-stream.txt` | S8 giliran 2 | State peringkat kedua |
