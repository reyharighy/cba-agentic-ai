...
```text
Berapa rata-rata skor kepuasan pelanggan (customer_satisfaction) per merek kendaraan?
```
...
Sistem menjelaskan bahwa kolom `customer_satisfaction` tidak ada pada skema `business_data` — tidak menghasilkan angka fiktif.
