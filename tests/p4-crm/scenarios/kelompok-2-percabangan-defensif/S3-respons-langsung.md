...
```text
Segmen apa yang berada di peringkat kedua?
```

## Konteks

Giliran ini mengikuti S1 (top-3 segment) dan S2 tanpa reset memori di antara.
...
**SME** — segmen peringkat kedua (3.029 pelanggan).
