...
```text
Berapa rata-rata probabilitas churn (churn_probability) per customer_segment?
```
...
Sistem menjelaskan bahwa kolom `churn_probability` tidak ada pada skema `business_data` — tidak menghasilkan angka fiktif.
