# Ringkasan Validasi — P4 (CRM / Churn)

| Field | Nilai |
| ----- | ----- |
| Profil | P4 — `dataset_4.csv` |
...
| -------- | -------- | ------- | ---------------- | ------- |
| S1 | K1 | — | Ya | Top 3 segment: Individual, SME, Enterprise |
| S2 | K2 | — | Ya | `punt_response`, tanpa memori |
| S3 | K2 | — | Ya | `direct_response`, SME peringkat 2 |
| S4 | K2 | — | Ya | `data_unavailability_response` (`churn_probability`) |
| S5 | K3 | retrieval retry once | Ya | Individual+Web tertinggi (3.021) |
| S6 | K3 | analytical retry once | Ya | Kuartil tenure + harness S6a |
| S7 | K3 | retrieval interrupt | Ya | `interrupt` → resume → `complete` |
| S8 | K4 | — | Ya | Bangladesh (g1) + Canada peringkat 2 (g2); memori 2 giliran |
...
Salin baris ini ke **Tabel 26** pada skripsi setelah pengujian selesai.
