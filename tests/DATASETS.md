...
Each profile **P1–P4** maps to `dataset_N.csv` (for example, P1 → `dataset_1.csv`). Test reports for each profile live under [`tests/`](.).
...
**P1** is the reference profile with the most detailed scenario documentation. **P2–P4** run the same S1–S8 orchestration scenarios on different business schemas to verify cross-domain behavior.
