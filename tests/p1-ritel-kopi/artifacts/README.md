...
| ------ | -------- | ---------- |
| `S1-stream.txt` | S1 | Jalur analitik penuh |
| `S2-stream.txt` | S2 | Permintaan luar domain |
| `S3-stream.txt` | S3 | Respons langsung |
| `S4-stream.txt` | S4 | Data tidak tersedia |
...
| `S8-g1-stream.txt` | S8 giliran 1 | Januari |
| `S8-g2-stream.txt` | S8 giliran 2 | Desember (bulan sebelumnya) |
