...
CMD ["sh", "-c", "uv run python -m docker_scripts.external_database_factory && uv run streamlit run main.py --server.port=${STREAMLIT_PORT} --server.address=0.0.0.0 --server.runOnSave=true --server.fileWatcherType none"]
